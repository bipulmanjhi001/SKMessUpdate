...
import skmess.com.rangedatepicker.CalendarCellView;
import skmess.com.rangedatepicker.CalendarGridView;
import skmess.com.rangedatepicker.DayViewAdapter;
import skmess.com.rangedatepicker.MonthView;
...
public class CalendarRowView extends ViewGroup implements View.OnClickListener {
  ...
  private skmess.com.rangedatepicker.MonthView.Listener listener;
  ...
  @Override protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    skmess.com.rangedatepicker.Logr.d("Row.onMeasure %d ms", System.currentTimeMillis() - start);
  }
  ...
  @Override protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
    ...
    skmess.com.rangedatepicker.Logr.d("Row.onLayout %d ms", System.currentTimeMillis() - start);
  }
