...
/**
 * ViewGroup that draws a grid of calendar cells.  All children must be {@link skmess.com.rangedatepicker.CalendarRowView}s.
...
public class CalendarGridView extends ViewGroup {
  ...
  public void setDayViewAdapter(DayViewAdapter adapter) {
    for (int i = 0; i < getChildCount(); i++) {
      ((skmess.com.rangedatepicker.CalendarRowView) getChildAt(i)).setDayViewAdapter(adapter);
    }
  }

  public void setDayBackground(int resId) {
    for (int i = 1; i < getChildCount(); i++) {
      ((skmess.com.rangedatepicker.CalendarRowView) getChildAt(i)).setCellBackground(resId);
    }
  }
  ...
  public void setDayTextColor(int resId) {
    for (int i = 0; i < getChildCount(); i++) {
      ...
      ((skmess.com.rangedatepicker.CalendarRowView) getChildAt(i)).setCellTextColor(colors);
    }
  }
  ...
  public void setHeaderTextColor(int color) {
    ((skmess.com.rangedatepicker.CalendarRowView) getChildAt(0)).setCellTextColor(color);
  }

  public void setTypeface(Typeface typeface) {
    for (int i = 0; i < getChildCount(); i++) {
      ((skmess.com.rangedatepicker.CalendarRowView) getChildAt(i)).setTypeface(typeface);
    }
  }
  ...
  @Override protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    skmess.com.rangedatepicker.Logr.d("Grid.onMeasure w=%s h=%s", MeasureSpec.toString(widthMeasureSpec),
        MeasureSpec.toString(heightMeasureSpec));
    int widthMeasureSize = MeasureSpec.getSize(widthMeasureSpec);
    if (oldWidthMeasureSize == widthMeasureSize) {
      skmess.com.rangedatepicker.Logr.d("SKIP Grid.onMeasure");
    ...
    skmess.com.rangedatepicker.Logr.d("Grid.onMeasure %d ms", System.currentTimeMillis() - start);
  }
  ...
  @Override protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
    ...
    skmess.com.rangedatepicker.Logr.d("Grid.onLayout %d ms", System.currentTimeMillis() - start);
  }
